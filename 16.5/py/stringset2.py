...
emptydir = "/Users/Simon/UNI_VII/bigdata/nzz/krieg/"
metadir = "/Users/Simon/UNI_VII/bigdata/nzz/metafiles/"

stringset2 = ['waffe','krieg','panzer','angriff','armee',u'militär','bombe','heer','kampf','schlacht','luftwaffe','streitkr','wehr']
...
for folder in folderlist:
    ...
    for file in filelist:
        ...
        for child in content.findall('P'): 
            ...
            if any(x in text.lower() for x in stringset2):
